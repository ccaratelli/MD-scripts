...
"""
This script calculates the difference in Free energy needed for the pKa calculation
from the three simulations performed
"""
...
print(' ')
print('Amount of MD-steps (min): ' +
      str(np.min([len(contentf), len(contentg), len(contenth)])))
