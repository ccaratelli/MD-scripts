...
parser = OptionParser("""This script calculates the average vertical energy difference.""")
parser.add_option(
...
g.write('#Step'+'\t''E1'+'\t\t'+'E2'+'\t\t''Delta E (eV)'+'\t\t'+'Running avg'+'\n')
...
for i in range(len(content)):
        ...
        delta_alles += delta
        lijst[i] = delta
        g.write(str(i)+'\t'+str(E1)+'\t'+str(E2)+'\t'+str(delta)+'\t'+str(delta_alles/counter)+'\n')
